...
class DX12Rendering::VertexBufferMap : public BufferMap<DX12VertexBuffer>
{
public:
	VertexBufferMap(UINT maxSize) : BufferMap<DX12VertexBuffer>(maxSize, sizeof(idDrawVert)) {};
...
class DX12Rendering::IndexBufferMap : public BufferMap<DX12IndexBuffer>
{
public:
	IndexBufferMap(UINT maxSize) : BufferMap<DX12IndexBuffer>(maxSize, sizeof(UINT16)) {};
...
protected:
	...
	BufferEntity<DX12IndexBuffer> CreateChildBuffer(UINT start, UINT size)
	{
		BufferEntity<DX12IndexBuffer> result;
